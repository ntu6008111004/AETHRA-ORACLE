...
export class OnboardingModal {
  ...
  static getFormData() {
    ...
    return {
      ...
      birthDate: isBirthDateUnknown ? null : (this.dateInput?.value || null),
      isBirthDateUnknown,
      birthTime: timeVal,
  ...
  static open(isForced = false) {
    ...
    if (this.dateInput) this.dateInput.value = isFirstVisit ? '' : (currentProfile.birthDate || '');
    if (this.timeInput) this.timeInput.value = isFirstVisit ? '' : (currentProfile.birthTime || '');
