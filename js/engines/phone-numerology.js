...
/**
 * ตัดทุกอย่างที่ไม่ใช่ตัวเลขออกจากเบอร์
 *
 * ต้องแปลงเลขไทยเป็นเลขอารบิกก่อน เพราะตัวกรองตัวเลขของภาษาโปรแกรม
 * ไม่นับเลขไทยว่าเป็นตัวเลข ถ้าผู้ใช้พิมพ์เบอร์เป็นเลขไทยจะโดนลบทิ้งหมด
 * แล้วระบบจะบอกว่าเบอร์ไม่ถูกต้อง ทั้งที่ผู้ใช้พิมพ์ถูก
 */
